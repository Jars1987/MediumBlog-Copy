  ...
  return (
    <main>
      ...
      <article className="mx-auto max-w-3xl p-5">
        ...
        <h2 className="font-ligth mb-2 text-xl text-gray-500 ">
          {post.description}
        </h2>
      ...
      {submitted ? (
        ...
        >
          ...
          <button className="shaddow focus:shadow-outline cursor pointer w-full rounded bg-yellow-500 py-2 px-4 font-bold text-white hover:bg-yellow-400 focus:outline-none ">
            Submit
          </button>
        </form>
      )}
